...
public class EstacionamentoServiceImp implements EstacionamentoService{
    ...
    public Optional<EstacionamentoDto> obterestacionadoPorId(String id) {
        ...
        if(estacionado.isPresent()){
            EstacionamentoDto pedidoComPizza = new ModelMapper().map(estacionado, EstacionamentoDto.class);
            pedidoComPizza.setDadosPizza(pizzariaClient.obterPizza(estacionadoComCarro.getIdPizza()));
