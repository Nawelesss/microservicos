...
public class EstacionamentoController {
    ...
    //Cadastrar pedido
    @PostMapping
    public ResponseEntity<EstacionamentoCompletoDto> cadastrarCarro(@RequestBody @Valid EstacionamentoCompletoDto estacionamento)
    {
        return new ResponseEntity<>(servico.CadastrarCarro(estacionamento),HttpStatus.CREATED);
    }
    ...
    //Atualizar pedido
    @PutMapping("/{id}")
    public ResponseEntity<EstacionamentoCompletoDto> atualizarEstacionado(@PathVariable String id,@RequestBody @Valid EstacionamentoCompletoDto estacionamento){
        Optional<EstacionamentoCompletoDto> retorno = servico.atualizarCarroPorId(id, estacionamento);
