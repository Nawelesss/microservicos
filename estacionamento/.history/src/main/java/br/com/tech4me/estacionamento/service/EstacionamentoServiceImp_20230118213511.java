...
public class EstacionamentoServiceImp implements EstacionamentoService{
    ...
    @Override
    public EstacionamentoCompletoDto Cadastrarestacionado(EstacionamentoCompletoDto dto) {
    ...
    @Override
    public Optional<EstacionamentoDto> atualizarestacionadoPorId(String id, EstacionamentoDto dto) {
