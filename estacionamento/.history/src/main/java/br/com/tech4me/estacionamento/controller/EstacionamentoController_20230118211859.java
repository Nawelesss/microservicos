...
public class EstacionamentoController {
    ...
    //Atualizar pedido
    @PutMapping("/{id}")
    public ResponseEntity<EstacionamentoDto> atualizarEstacionado(@PathVariable String id, @Valid EstacionamentoDto pedido){
        Optional<EstacionamentoDto> retorno = servico.atualizarEstacionadoPorId(id, pedido);
